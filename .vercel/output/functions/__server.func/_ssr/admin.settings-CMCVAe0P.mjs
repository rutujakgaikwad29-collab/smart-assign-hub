...
import { S as Shield, t as Database, u as Bell, v as Settings } from "../_libs/lucide-react.mjs";
...
function AdminSettings() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardLayout, { role: "admin", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 max-w-2xl", children: [{
      icon: Shield,
      title: "Security",
    ...
    }].map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl p-5 shadow-sm border border-border flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-muted flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "w-5 h-5 text-muted-foreground" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", children: "Configure" })
    ] }, i)) })
  ] }) });
}
export {
