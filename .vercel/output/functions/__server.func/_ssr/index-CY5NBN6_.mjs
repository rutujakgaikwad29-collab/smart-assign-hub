...
import { B as BookOpen, G as GraduationCap, d as Users, S as Shield } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: showSplash ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-2xl", children: roles.map((role, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.button,
            {
              initial: false,
              animate: { y: 0, opacity: 1 },
