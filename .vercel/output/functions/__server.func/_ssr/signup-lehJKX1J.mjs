...
import { R as Route$l, u as useAuth, i as isFirebaseConfigured, f as firebaseConfigMessage, g as getFirebaseAuthErrorMessage } from "./router-sh8vhz73.mjs";
...
import { B as BookOpen, C as CircleAlert, U as User, M as Mail, L as Lock, E as EyeOff, a as Eye, b as Building, H as Hash, A as ArrowLeft } from "../_libs/lucide-react.mjs";
...
function SignupPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen gradient-hero flex items-center justify-center px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: false, animate: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSignup, className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { icon: Mail, label: "Email", type: "email", placeholder: "you@example.com", value: form.email, onChange: (v) => updateForm("email", v) }),
      ...
      role === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { icon: Hash, label: "Faculty ID", placeholder: "FAC-2024-001", value: form.facultyId, onChange: (v) => updateForm("facultyId", v) }),
      role === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { icon: Hash, label: "Admin ID", placeholder: "ADM-001", value: form.adminId, onChange: (v) => updateForm("adminId", v) }),
