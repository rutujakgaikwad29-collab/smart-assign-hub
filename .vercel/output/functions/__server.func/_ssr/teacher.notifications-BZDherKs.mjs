...
import { F as FileText, C as CircleAlert, e as CircleCheck } from "../_libs/lucide-react.mjs";
...
const notifications = [{
  ...
  desc: "A student submitted an assignment 2 minutes ago.",
  time: "2m ago"
}, {
  icon: CircleAlert,
  title: "Late request pending",
  desc: "One late request needs review.",
  time: "15m ago"
}, {
  icon: CircleCheck,
  title: "Assignment published",
  desc: "Your assignment is now visible to students.",
  time: "1h ago"
}];
function TeacherNotificationsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardLayout, { role: "teacher", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-4xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Updates and alerts for your teaching workspace." })
    ] }),
...
export {
  TeacherNotificationsPage as component
};
